...
const API_BASE = process.env.NEXT_PUBLIC_API_URL || (isProd ? "https://joserman-twinlybackend2-0.hf.space" : "http://localhost:8000");
            ...
            <main className="w-full max-w-lg relative z-10">
                ...
                <div className="bg-white dark:bg-[#161B22] border border-white dark:border-white/10 rounded-[2.5rem] p-10 md:p-12 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] dark:shadow-2xl transition-all duration-300 relative overflow-hidden">
                    ...
                    <div className="space-y-6">
                        ...
                        {/* LinkedIn OAuth (UI only — backend pending) */}
                        <a
                            href="#"
                            onClick={(e) => { e.preventDefault(); }}
                            className="w-full flex items-center justify-center gap-3 bg-white dark:bg-[#1C2128] border border-slate-200 dark:border-white/10 text-slate-700 dark:text-[#F9FAFB] px-6 py-4 rounded-2xl font-semibold hover:bg-slate-50 dark:hover:bg-[#22272E] transition-all duration-300 shadow-sm relative"
                        >
                            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="#0A66C2">
                                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                            </svg>
                            Continue with LinkedIn
                            <span className="absolute right-4 text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 bg-slate-100 dark:bg-white/10 px-2 py-0.5 rounded-full">Soon</span>
                        </a>
