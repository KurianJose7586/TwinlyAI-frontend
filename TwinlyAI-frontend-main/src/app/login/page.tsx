                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex justify-center gap-4 w-full">
                            ...
                            <a
                                ...
                                className="flex-1 flex items-center justify-center bg-white dark:bg-[#1C2128] border border-slate-200 dark:border-white/10 px-6 py-4 rounded-2xl hover:bg-slate-50 dark:hover:bg-[#22272E] transition-all duration-300 shadow-sm"
                            >
                            ...
                            <a
                                ...
                                className="flex-1 flex items-center justify-center bg-white dark:bg-[#1C2128] border border-slate-200 dark:border-white/10 text-slate-700 dark:text-[#F9FAFB] px-6 py-4 rounded-2xl hover:bg-slate-50 dark:hover:bg-[#22272E] transition-all duration-300 shadow-sm"
                            >
                            ...
                            {/* LinkedIn OAuth */}
                            <a
                                href={`${API_BASE}/api/v1/oauth/login/linkedin`}
                                className="flex-1 flex items-center justify-center bg-white dark:bg-[#1C2128] border border-slate-200 dark:border-white/10 text-slate-700 dark:text-[#F9FAFB] px-6 py-4 rounded-2xl hover:bg-slate-50 dark:hover:bg-[#22272E] transition-all duration-300 shadow-sm"
                            >
